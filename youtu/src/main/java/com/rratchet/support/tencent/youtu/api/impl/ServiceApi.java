...
package com.rratchet.support.tencent.youtu.api.impl;

import com.rratchet.support.tencent.youtu.YouTu;
...
public class ServiceApi {
     ...
     */
    protected String request(String requestMethod, JSONObject data) throws Exception {
        if (isEnableSecurityAccess) {
            return executeHttpsRequest(requestMethod, data);
        } else {
            return executeHttpRequest(requestMethod, data);
        }
    }
     ...
     * @throws Exception the exception
     */
    private String executeHttpRequest(String requestMethod, JSONObject data) throws Exception {
...
//		connection.setReadTimeout(30000);
     ...
     * @throws Exception the exception
     */
    private String executeHttpsRequest(String requestMethod, JSONObject data) throws Exception {
